/**
 * Documents screen.
 * Patients (viewing their own id) can upload, edit, and delete their own documents.
 * Staff/admin (viewing another patient's id) get a read-only list — managing
 * documents on a patient's behalf happens on the web CRM.
 */
