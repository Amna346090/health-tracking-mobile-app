...
function PatientCard({ patient, onPress }: { patient: PatientRow; onPress: () => void }) {
  ...
  const dob = patient.dateOfBirth
    ? new Date(patient.dateOfBirth).toLocaleDateString(t('language.locale'), { month: 'short', day: 'numeric', year: 'numeric' })
    : null;
  ...
  return (
    <SafeAreaView style={styles.safe} edges={['top']}>
      ...
      <View style={styles.header}>
        <View>
          <Text style={styles.headerTitle}>{t('dashboard.clients')}</Text>
          {!loading && (
