...
function formatGender(
  gender: string | null,
  labels: { male: string; female: string; other: string; preferNotToSay: string },
): string {
  if (!gender) return '—';
  if (gender === 'MALE') return labels.male;
  if (gender === 'FEMALE') return labels.female;
  if (gender === 'PREFER_NOT_TO_SAY') return labels.preferNotToSay;
  return labels.other;
}
          ...
          <View style={styles.section}>
            ...
            <Card variant="outlined" padding={0}>
              <View style={styles.cardInner}>
                ...
                <ProfileRow label={t('profile.gender')}        value={formatGender(user.patientProfile.gender, {
                  male: t('patientForm.male'),
                  female: t('patientForm.female'),
                  other: t('patientForm.other'),
                  preferNotToSay: t('profile.preferNotToSay'),
                })} />
